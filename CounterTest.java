...
* Using the attached Modify CounterTester so that it does the following (remove/change/add code as needed);
...
* prints actual counter value 
* Your console output the CounterTester should look like this:
* Expected: 5
* Actual: 5
* Expected: -1
* Actual: -1
